{% macro UIFSM(UIFSM_pupils, portion_of_funding_year, school_days_per_year, funding_amount_per_pupil) %}
    ...
    ({{UIFSM_pupils}}) * {{ portion_of_funding_year }} * {{ school_days_per_year }} * {{ funding_amount_per_pupil }}
{% endmacro %}
