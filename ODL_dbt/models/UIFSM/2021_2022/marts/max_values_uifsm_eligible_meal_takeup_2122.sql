with values as (select 
    ...
    -- see notes tab of provisional calculations excel available here https://www.gov.uk/government/publications/universal-infant-free-school-meals-uifsm-2022-to-2023
...
from {{ref('joined_uifsm_meal_takeup_census_2122')}})
select 
 *,
